    ...
    <div className='w-full flex flex-col lg:flex-row'>
      ...
      <div className='lg:w-3/5 -mt-80 lg:mt-0 z-0  h-screen overflow-hidden'>
        <div className='w-full bg-blob-color h-screen lg:-mt-20 ml-10 rota scale rounded-blob-1 '>
            ...
            <Icon_Magnetic>
            <img src="https://i.ibb.co/LNmBY5J/one-and-only-rectangular-plate-of-food-vegetable-omlate-chicken-hyper-realistic-4k-smooth-pro-490600.png" alt="one-and-only-rectangular-plate-of-food-vegetable-omlate-chicken-hyper-realistic-4k-smooth-pro-490600" border="0" className='w-80 -ml-5 mt-14 z-20'/>
            </Icon_Magnetic>
