...
import Data_Lodder from "../../componennts/Home/Data_Lodder";
...
export default function Foods() {
  ...
  const category = [
    { value: "Fast Food", label: "https://i.ibb.co/brJpr0D/burg.png" },
    {
      value: "Biriyani",
      label:
        "https://i.ibb.co/6gwBTBX/chicken-biryani-traditional-indian-cuisine-png.webp",
    },
    {
      value: "Pasta",
      label:
        "https://i.ibb.co/ByRb7PH/pngtree-spaghetti-vector-element-png-image-4158219-removebg-preview.png",
    },
            ...
            <div className="flex flex-row">
              <div className=" md:h-auto ">
                ...
                <div className="mt-8 p-5 rounded-md bg-slate-100 hidden md:block">
                  ...
                  <p className="text-md font-semibold">
                    <span className="text-orange-00 text-lg">$</span>
                    {price}
                  </p>
              ...
              <div className=" hidden md:flex h-auto ">
                <div className="flex w-full items-center justify-center h-auto ">
                  {foods !== null ? (
                    ...
                    <div className="flex w-screen items-center justify-center h-auto  ">
                      <div className="flex w-ull items-center justify-center h-auto mr-[20rem] ">
                        <Data_Lodder />
                      </div>
                    </div>
                  )}
